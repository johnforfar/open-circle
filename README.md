...
Web3 Education Platform - Xnode/Nix compatible Next.js app.

## Modification Steps

1. Replace all instances of "open-circle" with the name of your project. This should be unique, as no apps with the same name can be run on a single Xnode.
2. Build your Nextjs app
3. Once your app is ready for deployment and runs using `nix run`, push to GitHub and copy your GitHub url (e.g. https://github.com/johnforfar/open-circle).
